def parse_es_coords(lat_str: str, lon_str: str) -> float:
    ...
    lat_dec = dms_to_dec(lat_deg, lat_min, lat_sec, lat_dir)
    lon_dec = dms_to_dec(lon_deg, lon_min, lon_sec, lon_dir)

    return lon_dec, lat_dec


def dms_to_dec(degree, minute, second, direction):
